...
class Weapon(object):
    ...
    def __init__(self, index):
        ...
        """
        self.index = index
        self.name = es.entitygetvalue(index, "classname")
        self.weapon_type = _cstrike.weapons[self.name]
...
def weapon_types_by_categories(*args):
    ...
    """
    if not args:
        return (_cstrike.weapons[weapon] for weapon 
                in _cstrike.weapons)
    return (weapon for weapon in _cstrike.weapons.itervalues() 
...
def weapon_types_by_slot(slot):
    ...
    """
    for weapon in _cstrike.weapons:
        weapon_object = _cstrike.weapons[weapon]
