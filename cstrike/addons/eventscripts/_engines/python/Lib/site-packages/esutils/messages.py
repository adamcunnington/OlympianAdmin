...
"""Provides intuitive methods to cover the range of general and player-specific
...
class _PlayerMessage(object):
    ...
    def __init__(self):
        ...
        es.usermsg("write", self._USERMSG_TYPE, self.name,
                   self._USERMSG_NUMBER)
...
class KeyHint(_PlayerMessage):
    """Represents a player-specific KeyHint dialogue."""
    USERMSG_CATERGORY = "KeyHintText"
    _USERMSG_NUMBER = 1
    _USERMSG_TYPE = "byte"
...
class _MOTD(_PlayerMessage):
    ...
    def __init__(self, type, title, contents, visible=True):
...
class MOTDFile(_MOTD):
    def __init__(self, title, contents, visible=True):
        super(MOTDText, self).__init__(_MOTD.TYPE_FILE, title, contents,
                                       visible)


class MOTDText(_MOTD):
    def __init__(self, title, contents, visible=True):
        super(MOTDText, self).__init__(_MOTD.TYPE_TEXT, title, contents,
                                       visible)


class MOTDURL(_MOTD):
    def __init__(self, title, contents, visible=True):
        super(MOTDText, self).__init__(_MOTD.TYPE_URL, title, contents,
                                       visible)
