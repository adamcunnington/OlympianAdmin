...
"""Catches exceptions raised and logs them for reference / error tracing where
...
class ExceptionManager(object):
    ...
    def _excepthook(self, type, value, traceback):
        try:
            ...
            self._sys_excepthook(type, value, traceback)
...
exception_manager = ExceptionManager() # To Do: Stop this shit.