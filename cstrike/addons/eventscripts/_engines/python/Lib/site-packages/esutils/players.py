...
"""Provides a simple API to access player attributes in a single uniform
...
class Player(object):
    ...
    def fade_in(self, delay, hold_time, red, green, blue, alpha):
        self._fade(2, delay, hold_time, red, green, blue, alpha)

    def fade_out(self, delay, hold_time, red, green, blue, alpha):
        self._fade(1, delay, hold_time, red, green, blue, alpha)
    ...
    def remove_fade(self, delay, hold_time, red, green, blue, alpha):
        self._fade(0, delay, hold_time, red, green, blue, alpha)
...
def get_player_from_name(name):
    ...
    """
    user_data = dict((player.name, player) for player in all_players())
